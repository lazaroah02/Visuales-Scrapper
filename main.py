...
class Main():
    def __init__(self):
        ...
        self.root.geometry(centrar_ventana(500, 500, self.root)) # posicionamiento de la ventana (ancho X alto + pixeles a la derecha + pixeles hacia abajo)
        ...
        self.label_url_serie = Label(self.frame, text = "URL de la serie")
        self.label_url_serie.place(x = 10, y = 10 )   
        
        #input para la url de la serie
        self.input_url_serie = Entry(self.frame)
        ...
        self.box_serie_or_temp = ttk.Combobox(self.frame, text = "Tipo de Scrapping", state = "readonly",
        ...
        #button para iniciar el scrapping para una serie
        self.button = Button(self.frame, text = "Iniciar Scrapping", command = self.iniciar_scrapping)
        self.button.config()
        self.button.place(x = 230, y = 148)
        
        #label to show the loading status
        self.label_loading = Label(self.frame, text = "Cargando")
